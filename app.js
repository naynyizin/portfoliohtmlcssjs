const getBoxContainer = document.querySelector(".box-container");
const textContainer = document.querySelector(".greeting-text-container");
const greetingImgCon = document.querySelector(".greeting-img-container");
const authorName = document.querySelector(".name");
const jobTitleCons = document.querySelectorAll(".job-title-container");
...
for (let i = 0; i < 365; i++) {
  ...
  getBoxContainer.appendChild(el);
}
...
window.addEventListener("scroll", function () {
  ...
  greetingImgCon.style.transform = `translate(${offsetY * 0.4}px,${
    offsetY * 0.7
  }px)`;
  authorName.style.transform = `translateX(${offsetY * 0.1}px)`;
  jobTitleCons[0].style.backgroundPositionY = `${offsetY * 0.5}px`;
  jobTitleCons[1].style.backgroundPositionY = `${-offsetY * 0.5}px`;
  ...
  phone[0].style.transform = `translateX(calc(430vh - ${offsetY}px))`;
  laptop.style.transform = `translateX(calc(-530vh + ${offsetY}px))`;
  phone[1].style.transform = `translateX(calc(630vh - ${offsetY}px))`;
});
